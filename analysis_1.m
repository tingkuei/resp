clear;
clc;
[X(:,1),X(:,2),time1]=textread('201501191337_download.txt','%f%f%s','headerlines',0);
[D(:,1),D(:,2),time2]=textread('20150119133728_parse.txt','%f%f%s','headerlines',0);
...
Data(6,:)=Std_Rscp(1,2:size(Std_Rscp,2));
figure(1);
subplot(3,1,1);
k=plot(Avg,'o-');
